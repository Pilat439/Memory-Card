...
questions_list.append(Question('Сколько планет в Солнечной Системе', '9', '10', '7', '8'))
questions_list.append(Question('Чему равно число "пи"', '3,14', '3,13', '3,33', '3,03'))
questions_list.append(Question('Как в старину на Руси называлась бухта или морской залив?', 'Лукоморье', 'Пахта', 'Заречье', 'Приморье'))
questions_list.append(Question('Согласно пословице, до какой столицы может довести язык?', 'Киев', 'Москва', 'Санкт-Петербург', 'Новгород'))
questions_list.append(Question('В какой стране проходили летние Олимпийские игры 2016 года?', 'Бразилия', 'Китай', 'Ирландия', 'Россия'))
questions_list.append(Question('Какая самая редкая группа крови?', 'I группа', 'II группа', 'III группа', 'IV группа'))
...
def check_answer():
    ...
    if answers[0].isChecked():
        ...
        window.score += 1
        result_test = window.score/window.total*100
        print('Рейтинг:', result_test, '%')
        print('Статитсика')
